...
<div class="p-4">
    <div>
        <div class="relative p-12 w-full sm:max-w-2xl sm:mx-auto">
            <div class="overflow-hidden z-0 rounded-full relative p-3">
                <form role="form" class="relative flex z-50 bg-white rounded-full" action="{{ route('products.index') }}" method="GET">
                    <input type="text" placeholder="search for a product here" name="search" value="{{ $search }}" class="rounded-full flex-1 px-6 py-4 text-gray-700 focus:outline-none">
    ...
    <br>
    @if($products->isEmpty())
    <h4 style="text-align: center;" class="mb-2 mt-0 text-4xl font-medium leading-tight text-primary">No results found for your product.</h4>
    @else
